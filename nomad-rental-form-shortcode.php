 ...
 *
 * The markup blends into YOOtheme Pro layouts by wrapping the booking bar in
 * a UIkit-flavoured card and using uk-icon attributes for the glyphs.
 */
...
if (! function_exists('nomad_rental_form_shortcode')) {
    ...
    function nomad_rental_form_shortcode($atts = []) {
        ...
        ?>
        <div class="nomad-rental-wrapper uk-position-relative" id="<?php echo esc_attr($unique_id); ?>">
